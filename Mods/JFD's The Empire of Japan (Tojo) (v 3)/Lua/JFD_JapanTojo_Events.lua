...
-- Author: JFD
--=======================================================================================================================
print("JFD's Japan (Tojo) Events: loaded")
--=======================================================================================================================
-- UTILITIES
--=======================================================================================================================
-- JFD_GetRandom
...
------------------------------------------------------------------------------------------------------------------------
-- JFD_IsPrestigeActive
------------------------------------------------------------------------------------------------------------------------
function JFD_IsPrestigeActive()
...
local isUsingPrestige   = JFD_IsPrestigeActive()
...
local Event_JFDJapanTojoDividedMilitary = {}
	...
	Event_JFDJapanTojoDividedMilitary.Outcomes[1].DoFunc = (
		function(player)
			...
			JFD_SendWorldEvent(playerID, Locale.ConvertTextKey("TXT_KEY_WORLD_EVENT_JFD_JAPAN_TOJO_DIVIDED_MILITARY_1"))
		end)
	--=========================================================
	-- Outcome 2
	--=========================================================
	...
	Event_JFDJapanTojoDividedMilitary.Outcomes[2].DoFunc = (
		function(player) 
			...
			JFD_SendWorldEvent(playerID, Locale.ConvertTextKey("TXT_KEY_WORLD_EVENT_JFD_JAPAN_TOJO_DIVIDED_MILITARY_2"))
		end)
	--=========================================================
	-- Outcome 3
	--=========================================================
	...
	Event_JFDJapanTojoDividedMilitary.Outcomes[3].DoFunc = (
		function(player) 
			...
			JFD_SendWorldEvent(playerID, Locale.ConvertTextKey("TXT_KEY_WORLD_EVENT_JFD_JAPAN_TOJO_DIVIDED_MILITARY_3", player:GetName()))
		end)
...
local Event_JFDJapanTojoEmperorsSummons = {}
	...
	Event_JFDJapanTojoEmperorsSummons.CanFunc = (
		function(player)			
			...
			if isUsingPrestige then
				local prestige = JFD_CalculatePrestigeRate(player:GetID())
				if prestige < (200 * iMod) then return false end
			end
	...
	Event_JFDJapanTojoEmperorsSummons.Outcomes[1].CanFunc = (
		function(player)	
			local rewardNum = mathCeil(12 * iMod)
			Event_JFDJapanTojoEmperorsSummons.Outcomes[1].Desc = Locale.ConvertTextKey("TXT_KEY_EVENT_JFD_JAPAN_TOJO_EMPERORS_SUMMONS_OUTCOME_RESULT_1", rewardNum)
			return true
		end
		)
	Event_JFDJapanTojoEmperorsSummons.Outcomes[1].DoFunc = (
		function(player) 
			local playerID = player:GetID()
			local rewardNum = mathCeil(12 * iMod)
			player:ChangeGoldenAgeTurns(rewardNum)
