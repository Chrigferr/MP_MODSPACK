...
VALUES	('JFD_RUSSIA_PETER_ATLAS', 			256, 		'JFD_RussiaPeterAtlas_256.dds',			2, 				2),
		...
		('JFD_RUSSIA_PETER_ALPHA_ATLAS', 	128, 		'JFD_RussiaPeterAlphaAtlas_128.dds',	1, 				1),
		('JFD_RUSSIA_PETER_ALPHA_ATLAS', 	80, 		'JFD_RussiaPeterAlphaAtlas_80.dds',		1, 				1),
		('JFD_RUSSIA_PETER_ALPHA_ATLAS', 	64, 		'JFD_RussiaPeterAlphaAtlas_64.dds',		1, 				1),
		('JFD_RUSSIA_PETER_ALPHA_ATLAS', 	48, 		'JFD_RussiaPeterAlphaAtlas_48.dds',		1, 				1),
		('JFD_RUSSIA_PETER_ALPHA_ATLAS', 	45, 		'JFD_RussiaPeterAlphaAtlas_45.dds',		1, 				1),
		('JFD_RUSSIA_PETER_ALPHA_ATLAS', 	32, 		'JFD_RussiaPeterAlphaAtlas_32.dds',		1, 				1),
		('JFD_RUSSIA_PETER_ALPHA_ATLAS', 	24, 		'JFD_RussiaPeterAlphaAtlas_24.dds',		1, 				1),
		('JFD_RUSSIA_PETER_ALPHA_ATLAS', 	16, 		'JFD_RussiaPeterAlphaAtlas_16.dds',		1, 				1),
...
VALUES	('COLOR_PLAYER_JFD_RUSSIA_PETER_ICON', 			0.933,	0.733,	0.243,	1),
		('COLOR_PLAYER_JFD_RUSSIA_PETER_BACKGROUND', 	0.321,	0.266,	0,		1);
------------------------------
-- PlayerColors
------------------------------			
INSERT INTO PlayerColors 
		(Type, 								PrimaryColor, 							SecondaryColor, 								TextColor)
VALUES	('PLAYERCOLOR_JFD_RUSSIA_PETER',	'COLOR_PLAYER_JFD_RUSSIA_PETER_ICON', 	'COLOR_PLAYER_JFD_RUSSIA_PETER_BACKGROUND', 	'COLOR_PLAYER_WHITE_TEXT');
--==========================================================================================================================
-- AUDIO
--==========================================================================================================================	
-- Audio_Sounds
