-- JFD_USSRStalinEvents
-- Author: JFD
--=======================================================================================================================
print("JFD's USSR (Stalin) Events: loaded")
--=======================================================================================================================
-- UTILITIES
--=======================================================================================================================
-- JFD_GetRandom
...
local Event_JFDUSSRStalinWorkerStrike = {}
	...
	Event_JFDUSSRStalinWorkerStrike.Outcomes[2].DoFunc = (
		function(player) 
			...
			JFD_SendWorldEvent(playerID, Locale.ConvertTextKey("TXT_KEY_JFD_WORLD_EVENT_USSR_STALIN_WORKER_STRIKE_2", player:GetCivilizationDescription()))
		end)
...
local Event_JFDUSSRStalinRevolutionaryMovement = {}
	...
	Event_JFDUSSRStalinRevolutionaryMovement.Outcomes[1].CanFunc = (
		function(player)	
			...
			Event_JFDUSSRStalinRevolutionaryMovement.Outcomes[1].Desc = Locale.ConvertTextKey("TXT_KEY_EVENT_JFD_USSR_STALIN_REVOLUTIONARY_MOVEMENT_OUTCOME_RESULT_1", wLTKD)
			return true
		end
		)
	Event_JFDUSSRStalinRevolutionaryMovement.Outcomes[1].DoFunc = (
		function(player) 
			local playerID = player:GetID()
			local wLTKD = mathCeil(25 * iGAMod)
			player:GetCapitalCity():ChangeWeLoveTheKingDayCounter(wLTKD)
