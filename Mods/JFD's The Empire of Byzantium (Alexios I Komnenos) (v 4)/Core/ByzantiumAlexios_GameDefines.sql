...
-- Cataphract
UPDATE Units
SET Class = 'UNITCLASS_KNIGHT', PrereqTech = 'TECH_CHIVALRY', Moves = 3, Combat = 25, Cost = 120, FaithCost = 240, ObsoleteTech = 'TECH_MILITARY_SCIENCE', GoodyHutUpgradeUnitClass = 'UNITCLASS_CAVALRY', Help = 'TXT_KEY_JFD_CATAPHRACT_HELP', Strategy = 'TXT_KEY_JFD_CATAPHRACT_STRATEGY'
...
SELECT	'CIVILIZATION_JFD_BYZANTIUM_ALEXIOS',	'CIVILIZATION_BYZANTIUM',	'TXT_KEY_CIV_JFD_BYZANTIUM_ALEXIOS_DESC',	'TXT_KEY_CIV_JFD_BYZANTIUM_ALEXIOS_SHORT_DESC',		'TXT_KEY_CIV_JFD_BYZANTIUM_ALEXIOS_ADJECTIVE',  CivilopediaTag,	'PLAYERCOLOR_JFD_BYZANTIUM_ALEXIOS', ArtDefineTag, ArtStyleType, ArtStyleSuffix, ArtStylePrefix, 'JFD_BYZANTIUM_ALEXIOS_ATLAS', 0, 				'JFD_BYZANTIUM_ALEXIOS_ALPHA_ATLAS', 	'Byzantium', 	'MapByzantiumAlexios512.dds',	'TXT_KEY_CIV5_DAWN_BYZANTIUM_ALEXIOS_TEXT',	'DOM_AlexiosI.dds'
