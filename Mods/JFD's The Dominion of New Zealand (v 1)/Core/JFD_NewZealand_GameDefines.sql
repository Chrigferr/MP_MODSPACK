...
VALUES		('BUILDINGCLASS_JFD_NEW_ZEALAND_1', 	'BUILDING_JFD_NEW_ZEALAND_TRADE_1', 	'BUILDING_JFD_NEW_ZEALAND_TRADE_DESC'),
			('BUILDINGCLASS_JFD_NEW_ZEALAND_2', 	'BUILDING_JFD_NEW_ZEALAND_TRADE_2', 	'BUILDING_JFD_NEW_ZEALAND_TRADE_DESC');
--==========================================================================================================================	
-- BUILDINGS
--==========================================================================================================================	
-- Buildings
...
INSERT INTO Buildings		
			(Type, 									BuildingClass, 			  			Cost, 	FaithCost,	GreatWorkCount,	NumTradeRouteBonus, FoodKept,	Description, 								Help,											NeverCapture)
VALUES		('BUILDING_JFD_NEW_ZEALAND_GROWTH', 	'BUILDINGCLASS_JFD_NEW_ZEALAND_1', 	-1, 	-1,			-1,				0,					0,			'TXT_KEY_BUILDING_JFD_NEW_ZEALAND_GROWTH', 	'TXT_KEY_BUILDING_JFD_NEW_ZEALAND_GROWTH_HELP',	1),
			('BUILDING_JFD_NEW_ZEALAND_TRADE_1', 	'BUILDINGCLASS_JFD_NEW_ZEALAND_1', 	-1, 	-1,			-1,				1,					0,			'TXT_KEY_BUILDING_JFD_NEW_ZEALAND_TRADE', 	'TXT_KEY_BUILDING_JFD_NEW_ZEALAND_TRADE_HELP',	1),
			('BUILDING_JFD_NEW_ZEALAND_TRADE_2', 	'BUILDINGCLASS_JFD_NEW_ZEALAND_2', 	-1, 	-1,			-1,				1,					0,			'TXT_KEY_BUILDING_JFD_NEW_ZEALAND_TRADE', 	'TXT_KEY_BUILDING_JFD_NEW_ZEALAND_TRADE_HELP',	1);
------------------------------
-- Building_YieldModifiers
------------------------------
INSERT INTO Building_YieldModifiers
			(BuildingType,						YieldType,		Yield)
VALUES		('BUILDING_JFD_NEW_ZEALAND_GROWTH',	'YIELD_FOOD',	10);
--==========================================================================================================================	
-- PROMOTIONS
--==========================================================================================================================	
-- UnitPromotions
...
INSERT OR REPLACE INTO UnitPromotions 
			(Type, 							Description, 					Help, 									 Sound, 				OutsideFriendlyLandsModifier,	AttackMod,	DefenseMod,	 IgnoreZOC,	CannotBeChosen,	PortraitIndex, 	IconAtlas, 			PediaType, 			PediaEntry)
VALUES		('PROMOTION_JFD_ANZAC',			'TXT_KEY_PROMOTION_ANZAC',		'TXT_KEY_PROMOTION_ANZAC_HELP', 		 'AS2D_IF_LEVELUP', 	10,								0,			0,			 0,			1,				59, 			'ABILITY_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_ANZAC'),
			('PROMOTION_JFD_DEFENDER',		'TXT_KEY_PROMOTION_DEFENDER',	'TXT_KEY_PROMOTION_DEFENDER_HELP', 		 'AS2D_IF_LEVELUP', 	0,								33,			33,			 1,			1,				59, 			'ABILITY_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_DEFENDER'),
			('PROMOTION_JFD_DEFENDER_INFO',	'TXT_KEY_PROMOTION_DEFENDER',	'TXT_KEY_PROMOTION_DEFENDER_INFO_HELP',  'AS2D_IF_LEVELUP', 	0,								0,			0,			 0,			1,				58, 			'ABILITY_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_DEFENDER');
--==========================================================================================================================
-- UNITS
--==========================================================================================================================
-- Units
...
VALUES		('CIVILIZATION_JFD_NEW_ZEALAND',	'LEADER_JFD_SEDDON');
--------------------------------	
-- Civilization_UnitClassOverrides 
--------------------------------		
INSERT INTO Civilization_UnitClassOverrides 
			(CivilizationType, 					UnitClassType, 						UnitType)
VALUES		('CIVILIZATION_JFD_NEW_ZEALAND', 	'UNITCLASS_GREAT_WAR_INFANTRY',		'UNIT_JFD_ANZAC'),
			('CIVILIZATION_JFD_NEW_ZEALAND', 	'UNITCLASS_IRONCLAD',				'UNIT_JFD_DEFENDER');
--------------------------------	
-- Civilization_Religions
--------------------------------			
INSERT INTO Civilization_Religions 
			(CivilizationType, 						ReligionType)
SELECT		('CIVILIZATION_JFD_NEW_ZEALAND'), 		ReligionType
...
VALUES		('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_0'),	
			('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_1'),
			('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_2'),
			('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_3'),
			('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_4'),
			('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_5'),
			('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_6'),
			('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_7'),
			('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_8'),
			('CIVILIZATION_JFD_NEW_ZEALAND', 		'TXT_KEY_SPY_NAME_JFD_NEW_ZEALAND_9');
--------------------------------	
-- Civilization_Start_Along_Ocean
--------------------------------	
INSERT INTO Civilization_Start_Along_Ocean 
			(CivilizationType, 						StartAlongOcean)
VALUES		('CIVILIZATION_JFD_NEW_ZEALAND', 		1);
--==========================================================================================================================
--==========================================================================================================================