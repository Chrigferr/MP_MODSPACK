...
local Decisions_JFD_RussiaCatherine_SmolnyInstitute = {}
	...
	function(player)
		...
		if load(player, "Decisions_JFD_RussiaCatherine_SmolnyInstitute") == true then
		...
		Decisions_JFD_RussiaCatherine_SmolnyInstitute.Desc = Locale.ConvertTextKey("TXT_KEY_DECISIONS_JFD_RUSSIA_CATHERINE_SMOLNY_INSTITUTE_DESC", goldCost)
	...
	function(player)
		...
		JFD_SendWorldEvent(player:GetID(), Locale.ConvertTextKey("TXT_KEY_WORLD_EVENT_JFD_CATHERINE_SMOLNY_INTITUTE", player:GetName(), player:GetCivilizationShortDescription())) 
