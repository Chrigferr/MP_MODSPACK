...
VALUES	('COLOR_PLAYER_JFD_MUSCOVY_ICON', 			0.831, 	0.772,	0.580, 	1),
		('COLOR_PLAYER_JFD_MUSCOVY_BACKGROUND',		0.372,	0.137,	0, 		1);
------------------------------
-- PlayerColors
------------------------------			
...
VALUES	('SND_LEADER_MUSIC_JFD_IVAN_PEACE', 	'IvanIV_Peace', 		'DynamicResident'),
		('SND_LEADER_MUSIC_JFD_IVAN_WAR', 		'IvanIV_War', 			'DynamicResident');	
------------------------------
-- Audio_2DSounds
------------------------------	
