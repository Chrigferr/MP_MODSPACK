...
INSERT INTO Buildings 	
		(Type, 						 		BuildingClass, 					NoOccupiedUnhappiness,	PlotCultureCostModifier, 	PlotBuyCostModifier, 	GreatWorkCount, Cost, FaithCost, NeverCapture,	PrereqTech, Description, 								Help)
VALUES	('BUILDING_JFD_SOBOR_COURTHOUSE', 	'BUILDINGCLASS_JFD_MUSCOVY',	1,						0, 							0, 						-1, 			-1,   -1, 		 1,				null, 		 'TXT_KEY_BUILDING_JFD_SOBOR_COURTHOUSE', 	'TXT_KEY_BUILDING_JFD_SOBOR_COURTHOUSE_HELP'),
		('BUILDING_JFD_SOBOR_FAITH', 		'BUILDINGCLASS_JFD_MUSCOVY',	0,						-1, 						-1, 					-1, 			-1,   -1, 		 1,				null, 		 'TXT_KEY_BUILDING_JFD_SOBOR_FAITH', 		'TXT_KEY_BUILDING_JFD_SOBOR_FAITH_HELP');
--------------------------------	
...
VALUES	('LEADER_JFD_IVAN', 	'TXT_KEY_LEADER_JFD_IVAN', 		'TXT_KEY_CIVILOPEDIA_LEADERS_JFD__IVAN_TEXT_1',		'TXT_KEY_CIVILOPEDIA_LEADERS_JFD_IVAN',		'IvanIV_Scene.xml',		9, 						4, 						3, 							8, 			4, 				2, 				7, 						4, 				4, 			7, 			7, 				3, 			6, 			'JFD_MUSCOVY_ATLAS',	1);
--------------------------------
...
VALUES	('LEADER_JFD_IVAN', 	'FLAVOR_OFFENSE', 					8),
		...
		('LEADER_JFD_IVAN', 	'FLAVOR_GOLD', 						9),
		('LEADER_JFD_IVAN', 	'FLAVOR_SCIENCE', 					2),
...
VALUES	('PROMOTION_JFD_STRELTSY', 			'TXT_KEY_PROMOTION_JFD_STRELTSY',	'TXT_KEY_PROMOTION_JFD_STRELTSY_HELP', 			'AS2D_IF_LEVELUP', 	1,			1,						1,				1, 				59, 			'ABILITY_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_STRELTSY'),
		('PROMOTION_JFD_STRELTSY_INFO', 	'TXT_KEY_PROMOTION_JFD_STRELTSY', 	'TXT_KEY_PROMOTION_JFD_STRELTSY_INFO_HELP', 	'AS2D_IF_LEVELUP',	1,			0,						0,				1, 				59, 			'ABILITY_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_STRELTSY');
--==========================================================================================================================	
-- UNITS
--==========================================================================================================================
-- Units
...
VALUES	('UNIT_JFD_STRELTSY', 	'PROMOTION_JFD_STRELTSY_INFO');	
--==========================================================================================================================	
-- MINOR CIVILIZATIONS
--==========================================================================================================================
-- MinorCivilizations
