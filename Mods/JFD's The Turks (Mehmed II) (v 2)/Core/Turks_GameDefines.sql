...
VALUES	('LEADER_JFD_MEHMED_II', 	'TXT_KEY_LEADER_JFD_MEHMED_II', 'TXT_KEY_CIVILOPEDIA_LEADERS_JFD_MEHMED_II', 	'MehmedII_Scene.xml',	8, 						2, 						3, 							7, 			4, 				2, 				4, 						3, 				3, 			3, 			4, 				2, 			7, 			'JFD_TURKS_ATLAS', 	1);
--------------------------------		
...
VALUES	('LEADER_JFD_MEHMED_II', 	'FLAVOR_OFFENSE', 					7),
		...
		('LEADER_JFD_MEHMED_II', 	'FLAVOR_SCIENCE', 					3),
...
SELECT	'CIVILIZATION_JFD_TURKS',	'CIVILIZATION_OTTOMAN',	'TXT_KEY_CIV_JFD_TURKS_DESC',	'TXT_KEY_CIV_JFD_TURKS_SHORT_DESC',	 'TXT_KEY_CIV_JFD_TURKS_ADJECTIVE',   'TXT_KEY_CIV5_JFD_TURKS_TEXT_1',	'TXT_KEY_CIV5_JFD_TURKS',	'PLAYERCOLOR_JFD_TURKS', ArtDefineTag, ArtStyleType, ArtStyleSuffix, ArtStylePrefix, 'JFD_TURKS_ATLAS', 0, 				'JFD_TURKS_ALPHA_ATLAS', 	'Ottoman', 		'JFD_TurksMehmedIIMap_512.dds',	'TXT_KEY_CIV5_DAWN_TURKS_TEXT',	'MehmedII_DOM.dds'
