...
INSERT INTO Specialists
		(Type,									Description,								Strategy,											GreatPeopleTitle, 									Experience, GreatPeopleUnitClass,		GreatPeopleRateChange,	Visible,	SlotTexture,			IconAtlas,						PortraitIndex)
VALUES	('SPECIALIST_JFD_PRUSSIAN_GENERAL',		'TXT_KEY_SPECIALIST_JFD_PRUSSIAN_GENERAL',	'TXT_KEY_SPECIALIST_JFD_PRUSSIAN_GENERAL_STRATEGY',	'TXT_KEY_SPECIALIST_JFD_PRUSSIAN_GENERAL_TITLE', 	5,			'UNITCLASS_GREAT_GENERAL',	3,						1,			'CitizenGeneral.dds',	'JFD_PRUSSIA_SPECIALIST_ATLAS',	0);
--------------------------------	
-- SpecialistFlavors
--------------------------------	
...
SELECT	'BUILDING_STATUE_OF_LIBERTY',	'SPECIALIST_JFD_PRUSSIAN_GENERAL',	YieldType, Yield
FROM Building_SpecialistYieldChanges WHERE BuildingType = 'BUILDING_STATUE_OF_LIBERTY';
--=======================================================================================================================
-- BUILDINGCLASSES
--=======================================================================================================================
-- BuildingClasses
...
VALUES	('BUILDINGCLASS_JFD_PRUSSIA', 	'BUILDING_JFD_PRUSSIAN_BARRACKS');
--==========================================================================================================================	
-- BUILDINGS
--==========================================================================================================================	
-- Buildings
...
INSERT INTO Buildings 	
		(Type, 										SpecialistType,							SpecialistCount, BuildingClass, Cost,	FaithCost,	NukeImmune, MinAreaSize, NeverCapture,	Description, Help,											PortraitIndex, 	IconAtlas)
SELECT	'BUILDING_JFD_PRUSSIAN_BARRACKS',			'SPECIALIST_JFD_PRUSSIAN_GENERAL',		2,				 BuildingClass, -1,		-1,			NukeImmune, MinAreaSize, 1,				Description, 'TXT_KEY_BUILDING_JFD_PRUSSIAN_MILITARY_HELP',	PortraitIndex, 	IconAtlas
FROM Buildings WHERE Type = 'BUILDING_BARRACKS';

INSERT INTO Buildings 	
		(Type, 										SpecialistType,							SpecialistCount, BuildingClass, Cost,	FaithCost,	NukeImmune, MinAreaSize, NeverCapture,	Description, Help,											PortraitIndex, 	IconAtlas)
SELECT	'BUILDING_JFD_PRUSSIAN_ARMORY',				'SPECIALIST_JFD_PRUSSIAN_GENERAL',		2,				 BuildingClass, -1,		-1,			NukeImmune, MinAreaSize, 1,				Description, 'TXT_KEY_BUILDING_JFD_PRUSSIAN_MILITARY_HELP',	PortraitIndex, 	IconAtlas
FROM Buildings WHERE Type = 'BUILDING_ARMORY';

INSERT INTO Buildings 	
		(Type, 										SpecialistType,							SpecialistCount, BuildingClass, Cost,	FaithCost,	NukeImmune, MinAreaSize, NeverCapture,	Description, Help,											PortraitIndex, 	IconAtlas)
SELECT	'BUILDING_JFD_PRUSSIAN_MILITARY_ACADEMY',	'SPECIALIST_JFD_PRUSSIAN_GENERAL',		2,				 BuildingClass, -1,		-1,			NukeImmune, MinAreaSize, 1,				Description, 'TXT_KEY_BUILDING_JFD_PRUSSIAN_MILITARY_HELP',	PortraitIndex, 	IconAtlas
...
VALUES	('PROMOTION_JFD_DEATHS_HEAD', 				'TXT_KEY_PROMOTION_JFD_DEATHS_HEAD', 			'TXT_KEY_PROMOTION_JFD_DEATHS_HEAD_HELP', 				'AS2D_IF_LEVELUP', 	1, 					0, 			1, 					0,							-10,					2,						0,				59, 			'ABILITY_ATLAS', 				'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_DEATHS_HEAD'),
		...
		('PROMOTION_JFD_DEATHS_HEAD_ZOC', 			'TXT_KEY_PROMOTION_JFD_DEATHS_HEAD_ZOC', 		'TXT_KEY_PROMOTION_JFD_DEATHS_HEAD_ZOC_HELP', 			'AS2D_IF_LEVELUP', 	1, 					1, 			1, 					0,							0,						0,						0,				59, 			'ABILITY_ATLAS', 				'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_DEATHS_HEAD_ZOC'),
		...
		('PROMOTION_JFD_LANDWEHR_DOUBLE', 			'TXT_KEY_PROMOTION_JFD_LANDWEHR', 				'TXT_KEY_PROMOTION_JFD_LANDWEHR_DOUBLE_HELP',			'AS2D_IF_LEVELUP', 	1, 					0, 			0, 					0, 							0,						0,						30,				59, 			'ABILITY_ATLAS', 				'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_LANDWEHR'),
		('PROMOTION_JFD_PRUSSIAN_VETERAN_4', 		'TXT_KEY_PROMOTION_JFD_PRUSSIAN_VETERAN_4', 	'TXT_KEY_PROMOTION_JFD_PRUSSIAN_VETERAN_HELP', 			'AS2D_IF_LEVELUP', 	1, 					0, 			0, 					50,							0,						0,						0,				2, 				'EXPANSION2_PROMOTION_ATLAS', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_JFD_PRUSSIAN_VETERAN_4'),
...
VALUES	('UNIT_JFD_DEATHS_HEAD', 	'PROMOTION_JFD_DEATHS_HEAD'),
		...
		('UNIT_JFD_DEATHS_HEAD', 	'PROMOTION_JFD_DEATHS_HEAD_ZOC'),
